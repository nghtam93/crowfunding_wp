<?php get_header(); ?>
    ...
    <section class="sc-lending" id="social-lending">
        <div class="container">
            ...
            <div class="sc__content wow animate__animated animate__fadeInUp">
                ...
                <div v-for="item in products" class="product__item ef--zoomin">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-66 wow animate__animated animate__fadeInRight">
                            <h3 class="el__title text-truncate"><a href="">{{ item.title }}</a></h3>
                            <div class="d-flex">
    ...
    <script type="text/javascript">
        var social_lending_app = new Vue({
          ...
          data: {
            products: [
                {
                    title : 'クラウドビルズ〇〇ファンド○号案件 0'
                },
                {
                    title : 'クラウドビルズ〇〇ファンド○号案件 1'
                },
                {
                    title : 'クラウドビルズ〇〇ファンド○号案件 2'
                },
                {
                    title : 'クラウドビルズ〇〇ファンド○号案件 3'
                },
                {
                    title : 'クラウドビルズ〇〇ファンド○号案件 4'
                }
            ],
            mod_title: 'ソーシャルレンディング'
          }
        });
