...
<div class="wrap__page">   
    <div class="container">
        <header class="page__header">
            <h1 class="page__header__title">～～～の詳細</h1>
        </header><!-- .page-header -->
        ...
        <div class="table-of-contents">
            ...
            <ul class="el__list">
                <li><a href="">見出し2が入ります見出し2が入ります</a>
                    <ul class="-sub">
                        <li><a href="">見出し3が入ります見出し3が入ります</a></li>
                        <li><a href="">見出し3が入ります見出し3が入ります</a></li>
                        <li><a href="">見出し3が入ります見出し3が入ります</a></li>
                    </ul>
                </li>
                ...
                <li><a href="">見出し2が入ります見出し2が入ります</a></li>
            </ul>
        </div>
        ...
        <div class="single-lenders__content">
            ...
            <header class="page__header">
                <h2 class="page__header__title">～～～の特徴</h2>
            </header><!-- .page-header -->
            <div class="single-lenders__img">
                <img src="images/lenders-details/lenders-details-img.png" alt="">
            </div>
...
<section class="sc-customer">
    <div class="container">
        <header class="page__header">
            <h2 class="page__header__title">～～～のクチコミ・レビュー</h2>
        </header><!-- .page-header -->
        ...
        <div class="single-lenders__rating d-md-flex">
            ...
            <div class="el__col col-md-6">
                ...
                <span class="color-secondary">36件</span>
            </div>
        </div>
